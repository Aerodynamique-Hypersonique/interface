            ...
            html.H1(children='Création du profil'),
                html.Div(children=[
                    ...
                    html.Div(children=[
                        ...
                        dcc.Input(id='input-length', placeholder='Entrez la taille du profil', type='number', disabled=True),
                        html.B("Angle du profil", id='text-input-angle'),
                        dcc.Input(id='input-angle', placeholder="Entrez l'angle du profil", type='number', disabled=True),
            ...
            html.Div(children=[
                ...
                html.Div([
                    ...
                    dcc.Input(id='input-altitude', placeholder="Entrez l'altitude", type='number',
                              ...
                              style={'backgroundColor': '#3a3a3a', 'color': '#f0f0f0'}),
                    html.B("Vitesse"),
                    dcc.Input(id='input-velocity-x', placeholder="Entrez la vitesse", type='number',
                              value=0, 
                              style={'backgroundColor': '#3a3a3a', 'color': '#f0f0f0'}),
                    html.B("Gravité (m.s2)"),
